...
def subroutineloaddat(fname, compstartdate):
    ...
    with open(fname) as file:
        ...
        for line in (file.readlines() [-1::-1]):
            ...
            # print("line 123")
            # print(dat_dt_temp, compstartdate)
...
def subroutinecheckdata(comprehensivefile,compstartrow, dat_dt, dat_data):
    ...
    # print(len(comprehensivefile), compstartrow, len(dat_data), compendrow)
    ...
    #        print(comprehensivefile[8,icolumnoutput], comprehensivefile[1,icolumnoutput])
            ...
            for icolumnsite in range(len(instrumentelementnumbers)):
                ...
                if str(instrumentelementnumbers[icolumnsite])==str(comprehensivefile[1,icolumnoutput].replace('_original','')):
                    ...
                    # pastethis = dat_data[:,icolumnsite+4] 
                    print(pastethis)
                    comprehensivefile[compstartrow:compendrow,icolumnoutput] = pastethis   
                    #comprehensivefile[compstartrow:compendrow,icolumnoutput + 1] = pastethis                
...
if __name__ == "__main__":
    ...
    comprehensivelocation = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank_month\\SAO_2023-04_ComprehensiveFormat.csv'


    #datlocation = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank month\\SAO_A.dat'
    #datlocation = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank month\\SAO_B.dat'
    #datlocation = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank month\\SAO_C.dat'
    #datlocation = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank_month\\SAO_C.dat'
    # use a b c files
    ...
    sitefilelocation = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank_month\\SAO_consolodated_sitefile.xlsx'
