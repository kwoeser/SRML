...
def subroutinegetsitefileinfo(sitefile_complete, date):
    ...
    print('Inside 2.1 subroutinegetsitefileinfo')
    ...
    # Get information from this sitefile record [row,col]
...
def findsunrisesunsetnoon(datedaysonly, findthisangle, szavsazm, plusminus, latitude, longitude, altitude):
    ...
    print('Inside 2.2.1 findsunrisesunsetnoon')
...
sitefilefolder = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank month\\'

# Get the sitefile for this station       
sitefilelocation = sitefilefolder + station + '_consolodated_sitefile.xlsx'

# Name of the output file.
outputname = station + '_' + str(year) + '-' + ('0' if (month<10) else '') + str(month) + '_karma_ComprehensiveFormat.csv' 

# Define the output location
outputlocation = 'C:\\Users\\KARMA\\Desktop\\SRML_Blank month\\' + outputname 
